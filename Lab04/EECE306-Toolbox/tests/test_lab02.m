...
%   Checks spherical pole values and cylindrical
...
em.test.assertClose(esph, 0, tol, 'Spherical roundtrip error');
...
em.test.assertClose(ecyl, 0, tol, 'Cylindrical roundtrip error');
